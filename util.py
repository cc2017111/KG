...
from NLU.sklearn_Classification.clf_model import CLF_Model
from utils.json_uitls import load_user_dialogue_context, dump_user_dialogue_context
from config import *
...
clf_model = CLF_Model(os.path.join(base_path, 'NLU/sklearn_Classification/model_file/'))
